      ...
      <div class="content-header-section">
          ...
          <div class="btn-group" role="group">
              ...
              <div class="dropdown-menu dropdown-menu-right min-width-200" aria-labelledby="page-header-user-dropdown">
                  ...
                  <a href="javascript:void(0);" class="dropdown-item"  data-toggle="modal" data-target="#change-password">
                      <i class="si si-key mr-5"></i> Change Password
                  </a>

                  <div class="dropdown-divider"></div>

                  <a class="dropdown-item" href="javascript:void(0);" onclick="event.preventDefault(); var res = confirmBoxLogout('Are you sure ?',`You will be logged out.`);">
